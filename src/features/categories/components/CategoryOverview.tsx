...
export default function CategoryOverview({ name, description, thumbnailImage }: Category) {
  if (!name) return null;
    ...
    <section className="mt-8" itemScope itemType="https://schema.org/CollectionPage">
      <Card className="flex flex-col items-center">
        <CardHeader className="flex flex-col items-center text-center">
          ...
          <h1 className="text-2xl sm:text-3xl font-extrabold mb-4 text-gray-900 text-right text-nowrap" itemProp="name">
            {name}
          </h1>
        </CardHeader>
