...
const ProductCardAmazing: FC<Props> = ({ product }) => {
  ...
  return (
    <div className="p-px mb-0.5 border-r rounded-none">
      <div className="p-2 md:p-4">
        ...
        <div className="mb-2">
          <Link href={`/product/${slug}`} className="line-clamp-2 h-10 text-xs md:h-12 md:text-sm hover:text-primary">
            <h3>{productName}</h3>
          </Link>
        </div>
...
export default ProductCardAmazing;
