...
const ProductPriceAmazing: FC<Props> = ({ basePrice, salePrice }) => {
        ...
        <>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm font-bold text-primary md:text-base">
              ...
              {salePrice && <span className="text-xs font-light md:text-xs"> تومان</span>}
            </div>
          </div>
        </>
      ) : (
            ...
            <div className="text-sm font-bold text-primary md:text-base">
              {basePrice ? (
                <>
                  ...
                  <span className="text-xs font-light md:text-xs"> تومان</span>
                </>
              ) : (
...
export default ProductPriceAmazing;
